...
export const timeline: TimelineItem[] = [
  {
    ...
    org: "Insurtech Pvt. Ltd.",
    period: "September 2025 — Present",
    details: "Building and improving production insurance technology products with Next.js, PostgreSQL, Supabase, Vercel hosting, and Cloudflare CDN, covering UI delivery, API integration, database-backed features, and deployment workflows.",
    type: "work"
  },
  {
    id: "w0",
